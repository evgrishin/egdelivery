...
class Egdelivery extends CarrierModule
{
    ...
    public function getContent()
    {
         ...
         */
        if (((bool)Tools::isSubmit('submitEgdeliveryModule')) == true) {
            $this->postProcess();
        }
    ...
    protected function renderForm()
    {
        ...
        $helper->submit_action = 'submitEgdeliveryModule';
            ...
            'form' => array(
                ...
                'input' => array(
                    ...
                    array(
                        ...
                        'name' => 'EGDELIVERY_ACCOUNT_EMAIL',
                        'label' => $this->l('Email'),
                    ),
                    array(
                        'type' => 'password',
                        'name' => 'EGDELIVERY_ACCOUNT_PASSWORD',
    ...
    {
        return array(
            'EGDELIVERY_LIVE_MODE' => Configuration::get('EGDELIVERY_LIVE_MODE', true),
            'EGDELIVERY_ACCOUNT_EMAIL' => Configuration::get('EGDELIVERY_ACCOUNT_EMAIL', 'contact@prestashop.com'),
            'EGDELIVERY_ACCOUNT_PASSWORD' => Configuration::get('EGDELIVERY_ACCOUNT_PASSWORD', null),
        );
    }
